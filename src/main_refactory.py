...
while True:
        ...
        transformated_files = load_pipeline.move_files_to_month_subfolder(data_raw_path, target_directory)
        
        """ files_consolidated = consolidator.list_files_to_consolidate(target_directory)
        
        if files_consolidated: """
        consolidator.merge_excel_reports(target_directory)
        # transform_pipeline.format_styles_report_sheet(files_consolidated, target_directory)
